    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                            ...
                            @auth
                                <x-dropdown>
                                    ...
                                    <x-slot name="content">
                                        ...
                                        @can('update', $idea)
                                            <x-dropdown-link :href="route('idea.edit', $idea)"> {{-- se usa ':' para enviar algo dinámico--}}
                                                Editar
                                            </x-dropdown-link>
                                        @endcan

                                        @can('delete', $idea)
                                            <form method="POST" action="{{route('idea.delete' , $idea)}}"> {{--Usa JAVASCRIPT porque esto no es un botón sino un dropdown--}}
                                                @csrf
                                                @method('delete')
                ...
                @empty
                    <h2 class="text-white p-4">No existen ideas para esta opción</h2>
                @endforelse
                {{--endfor--}}
            </div>
        </div>
